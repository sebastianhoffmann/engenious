...
namespace engenious.Content.Pipeline
{
    ...
    public class BitmapProcessor : ContentProcessor<Bitmap, TextureContent, BitmapProcessorSettings>
    {
        ...
        {
            var data = input.LockBits(new System.Drawing.Rectangle(0, 0, input.Width, input.Height),
                System.Drawing.Imaging.ImageLockMode.ReadOnly, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
            var content = new TextureContent(context.GraphicsDevice, !_settings.AutoGenerateMipMaps,
                _settings.MipMapCount, data.Scan0, input.Width, input.Height, TextureContentFormat.Png, _settings.Format);

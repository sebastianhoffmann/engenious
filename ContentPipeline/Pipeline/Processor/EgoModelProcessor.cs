...
namespace engenious.Pipeline
{
    ...
    {
        private static void RemoveFrame(AnimationContent anim, int index)
        {
        ...
        {
            RemoveFrame(input.Animations[0], input.Animations[0].Channels[0].Frames.Count - 1);
                //letzte frame entfernen...
            RemoveFrame(input.Animations[1], input.Animations[1].Channels[0].Frames.Count - 1);
                //letzte frame entfernen...
            RemoveFrame(input.Animations[2], 0); //letzte frame entfernen...
            RemoveFrame(input.Animations[3], input.Animations[3].Channels[0].Frames.Count - 1);
                //letzte frame entfernen...
            RemoveFrame(input.Animations[4], 0); //letzte frame entfernen...

            RemoveFrame(input.Animations[5], input.Animations[5].Channels[0].Frames.Count - 1);
                //letzte frame entfernen...
            RemoveFrame(input.Animations[6], input.Animations[6].Channels[0].Frames.Count - 1);
                //letzte frame entfernen...

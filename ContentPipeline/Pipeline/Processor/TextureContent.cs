...
namespace engenious.Content.Pipeline
{
    public class TextureContent
    {
        ...
        public TextureContent(GraphicsDevice graphicsDevice,bool autoGenerateMipMaps, int mipMapCount, byte[] inputData, int width, int height, TextureContentFormat inputFormat, TextureContentFormat outputFormat)
        {
        ...
        public TextureContent(GraphicsDevice graphicsDevice,bool autoGenerateMipMaps, int mipMapCount, IntPtr inputData, int width, int height, TextureContentFormat inputFormat, TextureContentFormat outputFormat)
        {
            this.graphicsDevice = graphicsDevice;

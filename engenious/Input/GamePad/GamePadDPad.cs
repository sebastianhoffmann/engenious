...
namespace engenious.Input
{
    public struct GamePadDPad : IEquatable<GamePadDPad>
    {
        ...
        public bool IsDown
        {
            get { return (byte) (_buttons & DPadButtons.Down) != 0; }
            internal set { SetButton(DPadButtons.Down, value); }
        }

        public bool IsLeft
        {
            get { return (byte) (_buttons & DPadButtons.Left) != 0; }
            internal set { SetButton(DPadButtons.Left, value); }
        }

        public bool IsRight
        {
            get { return (byte) (_buttons & DPadButtons.Right) != 0; }
            internal set { SetButton(DPadButtons.Right, value); }
        }

        public bool IsUp
        {
            get { return (byte) (_buttons & DPadButtons.Up) != 0; }
        ...
        {
            _buttons =
                (DPadButtons) (state & (Buttons.DPadUp | Buttons.DPadDown | Buttons.DPadLeft | Buttons.DPadRight));
        }
